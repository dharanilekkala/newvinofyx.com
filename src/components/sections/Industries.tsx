...
export default function Industries() {
  ...
  return (
    <section id="industries" ref={ref} className="section-pad bg-dark overflow-hidden">
          ...
          {INDUSTRIES.map(({ name, icon }, i) => {
            ...
            return (
              <motion.div
                ...
                className="group flex flex-col items-center gap-3 p-5 rounded-2xl border border-gold/8 bg-dark-700/30 hover:border-gold/25 hover:bg-dark-700/70 transition-all duration-300 cursor-default text-center"
              >
                ...
                <span className="text-white/65 text-xs font-medium leading-tight group-hover:text-white transition-colors">
                  {name}
                </span>
              </motion.div>
            );
